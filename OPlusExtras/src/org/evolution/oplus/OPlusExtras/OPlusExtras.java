...
public class OPlusExtras extends PreferenceFragment
    ...
    public static final String KEY_PCC_SWITCH = "pcc_override";
    ...
    private static TwoStatePreference mPCCModeSwitch;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        // PCC Override
        displayCategory = displayCategory | isFeatureSupported(context, R.bool.config_deviceSupportsPCCOverride);
        if (isFeatureSupported(context, R.bool.config_deviceSupportsPCCOverride)) {
            mPCCModeSwitch = (TwoStatePreference) findPreference(KEY_PCC_SWITCH);
            mPCCModeSwitch.setEnabled(PCCModeSwitch.isSupported(this.getContext()));
            mPCCModeSwitch.setChecked(PCCModeSwitch.isCurrentlyEnabled(this.getContext()));
            mPCCModeSwitch.setOnPreferenceChangeListener(new PCCModeSwitch());
        }
        else {
            findPreference(KEY_PCC_SWITCH).setVisible(false);
        }
